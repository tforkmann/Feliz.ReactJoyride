...
module Interop =
    ...
    let inline mkReactourStylesProp (key: string) (value: obj) : IReactourStylesProp = unbox (key, value)
    let inline mkReactourStyleProp (key: string) (value: obj) : IReactourStyleProp = unbox (key, value)
